...
def main(argv=sys.argv[1:]):
    ...
    try:
        ...
        res['valid'] = False
        res["error_message"] = str.format("{0}:{1}",exclass, str(ex))
        ...
        res = {
            "error_message": 'Unknown HPXML Translation Error: Please contact HEScore support',
            "python_error": type(e).__name__+":"+str(e),
            "valid":False
        }
        ...
        # sys.exit(2)
    try:
        res['response'] = t.hpxml_to_hescore_json(
            args.output,
